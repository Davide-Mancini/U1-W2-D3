...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  femaleCharacters = femaleCharacters + starWarsCharacters[i].gender;
}
...
// // }
// // switch(starWarsCharacters[i].eye_color === 'blue'){
// //   case:
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  while (crewMass < starWarsCharacters[i].mass) {}
}
...
*/
let newGender = "robot";
for (starWarsCharacters[i].gender === 'n/a'); {
